    ...
    <section className="space-y-3">
      <div className="rounded-2xl border border-gray-100 bg-white p-4 shadow-[0_1px_0_rgba(0,0,0,0.03)]">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            <h2 className="text-base font-semibold text-[#1e2a52]">Analytics</h2>
          ...
          <div className="flex flex-wrap items-center gap-2">
                ...
                return (
                  <button
                    ...
                    className={`rounded-full px-3 py-1 text-xs font-semibold transition ${
                      active ? "bg-white text-indigo-700 shadow-sm" : "text-gray-600 hover:text-gray-800"
                    }`}
                  >
                    {r.label}
                  </button>
            ...
            <button
              type="button"
              className="inline-flex h-9 items-center gap-2 rounded-full border border-gray-200 bg-white px-4 text-xs font-semibold text-gray-700 hover:border-indigo-200 hover:text-indigo-700"
            >
              Export
        ...
        <div className="mt-4 grid gap-3 sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-6">
          {kpis.map((k) => (
            ...
            >
              ...
              <p className="text-xs font-medium text-gray-500">{k.title}</p>
      ...
      <div className="grid gap-3 xl:grid-cols-[2fr_1fr]">
        <div className="rounded-2xl border border-gray-100 bg-white p-4 shadow-[0_1px_0_rgba(0,0,0,0.03)]">
          <div className="mb-3">
            <p className="text-sm font-semibold text-[#1e2a52]">Weekly Lead Progression</p>
            <p className="mt-1 text-[11px] text-gray-400">New leads, engaged, and converted per week</p>
          </div>
            ...
            {weeklyBars.map((w) => {
              ...
              return (
                <div key={w.label} className="flex flex-1 flex-col items-center gap-2">
                  <div className="flex h-44 w-full max-w-[120px] items-end justify-center rounded-2xl bg-gray-50 p-2 ring-1 ring-gray-100">
                    <div className="flex h-full w-10 flex-col-reverse overflow-hidden rounded-xl bg-white ring-1 ring-gray-100">
          ...
          <div className="mt-4 flex flex-wrap items-center justify-center gap-4 text-[11px] text-gray-500">
        ...
        <div className="rounded-2xl border border-gray-100 bg-white p-4 shadow-[0_1px_0_rgba(0,0,0,0.03)]">
          <div className="mb-3">
            <p className="text-sm font-semibold text-[#1e2a52]">Conversion by Scenario</p>
            <p className="mt-1 text-[11px] text-gray-400">% of leads converted per scenario</p>
          </div>
          ...
          <div className="space-y-3">
            {scenarioConversion.map((s) => (
              <div key={s.id} className="flex items-center gap-3">
                ...
                <div className="w-10 text-right text-xs font-semibold text-gray-700">{s.pct}%</div>
      ...
      <div className="grid gap-3 xl:grid-cols-3">
        <div className="rounded-2xl border border-gray-100 bg-white p-4 shadow-[0_1px_0_rgba(0,0,0,0.03)]">
          <div className="mb-3">
            <p className="text-sm font-semibold text-[#1e2a52]">Agent Performance</p>
            <p className="mt-1 text-[11px] text-gray-400">Throughput and latency per agent</p>
          </div>
          ...
          <div className="overflow-x-auto">
            <table className="min-w-[640px] w-full border-separate border-spacing-0">
              ...
              <tbody>
                {agentRows.map((row) => (
                  <tr key={row.agent} className="border-t border-gray-100 text-xs text-gray-700 hover:bg-gray-50/60">
                    <td className={`px-3 py-2 font-semibold ${row.tone}`}>{row.agent}</td>
                    <td className="px-3 py-2 font-medium text-gray-800">{row.processed}</td>
                    <td className="px-3 py-2 text-gray-600">{row.latency}</td>
        ...
        <div className="rounded-2xl border border-gray-100 bg-white p-4 shadow-[0_1px_0_rgba(0,0,0,0.03)]">
          <div className="mb-3">
            <p className="text-sm font-semibold text-[#1e2a52]">Email Performance</p>
            <p className="mt-1 text-[11px] text-gray-400">Across all campaigns</p>
          </div>
            ...
            {emailBars.map((b) => (
              <div key={b.label}>
                <div className="mb-1 flex items-center justify-between text-[11px] text-gray-500">
                  <span>{b.label}</span>
                  <span className="font-semibold text-gray-700">{b.value.toFixed(1)}%</span>
                </div>
          ...
          <div className="mt-4 rounded-2xl border border-gray-100 bg-gray-50 p-3">
            <p className="text-[11px] font-semibold text-gray-500">Top performing</p>
            <div className="mt-2 space-y-2">
              <div className="flex items-center justify-between rounded-xl bg-white px-3 py-2 ring-1 ring-gray-100">
                <p className="text-xs font-semibold text-gray-800">S3 Welcome Email</p>
                <p className="text-xs font-semibold text-emerald-700">52% open</p>
              </div>
              <div className="flex items-center justify-between rounded-xl bg-white px-3 py-2 ring-1 ring-gray-100">
                <p className="text-xs font-semibold text-gray-800">S5 Product Nudge</p>
        ...
        <div className="rounded-2xl border border-gray-100 bg-white p-4 shadow-[0_1px_0_rgba(0,0,0,0.03)]">
          <div className="mb-3">
            <p className="text-sm font-semibold text-[#1e2a52]">HITL Gate Stats</p>
            <p className="mt-1 text-[11px] text-gray-400">Approval metrics by gate</p>
          </div>
              ...
              >
                <div className="flex items-start justify-between gap-3">
                  <div>
                    ...
                    <p className="mt-2 text-[11px] text-gray-400">{g.meta}</p>
                  </div>
      ...
      <div className="grid gap-3 lg:grid-cols-2">
        <div className="rounded-2xl border border-gray-100 bg-white p-4 shadow-[0_1px_0_rgba(0,0,0,0.03)]">
          <div className="mb-3">
            <p className="text-sm font-semibold text-[#1e2a52]">Lead Score Distribution</p>
            <p className="mt-1 text-[11px] text-gray-400">Current score spread across all active leads</p>
          </div>

          <div className="flex h-44 items-end justify-between gap-2 rounded-2xl bg-gray-50 p-3 ring-1 ring-gray-100">
            {scoreBuckets.map((b) => (
        ...
        <div className="rounded-2xl border border-gray-100 bg-white p-4 shadow-[0_1px_0_rgba(0,0,0,0.03)]">
          <div className="mb-3">
            <p className="text-sm font-semibold text-[#1e2a52]">LLM Token Usage</p>
            <p className="mt-1 text-[11px] text-gray-400">GPT-4 and GPT-4 mini consumption this month</p>
          </div>
