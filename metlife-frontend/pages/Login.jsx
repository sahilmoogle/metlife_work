      ...
      <div className="mx-auto flex min-h-screen max-w-[1600px]">
        ...
        <section className="flex w-full flex-col bg-white px-6 py-8 sm:px-10 lg:w-1/2 lg:px-16">
          ...
          <div className="mx-auto flex w-full max-w-[460px] flex-1 flex-col justify-center">
            <h3 className="text-sm font-medium text-gray-600">Log in to</h3>
            ...
            <form onSubmit={handleSubmit} className="mt-8">
              ...
              <div className="relative mb-4">
                ...
                <input
                  ...
                  autoComplete="email"
                  required
                  className="h-11 w-full rounded-full border border-gray-200 bg-white pl-11 pr-4 text-sm text-gray-700 outline-none transition focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100"
                />
              </div>
